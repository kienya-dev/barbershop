(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        isWebp();
        const initSliders = () => {
            if (document.querySelector("[data-main-slider]")) new core("[data-main-slider]", {
            ...
            if (document.querySelector("[data-brands-slider]")) new core("[data-brands-slider]", {
                modules: [ Navigation ],
                slidesPerView: 1,
                spaceBetween: 20,
                speed: 800,
            ...
            if (document.querySelector("[data-portfolio-slider]")) new core("[data-portfolio-slider]", {
                modules: [ Navigation ],
                slidesPerView: 1,
                spaceBetween: 20,
                speed: 800,
